...
static void	validate_red_color(t_cub3d *cub3d)
{
	...
	if (red < 0 || red > 255)
		b_print_error(cub3d, "Red color of F must be a value between 0-255.");
...
static void	validate_green_color(t_cub3d *cub3d)
{
	...
	if (green < 0 || green > 255)
		b_print_error(cub3d, "Green color of F must be a value between 0-255.");
...
static void	validate_blue_color(t_cub3d *cub3d)
{
	...
	if (blue < 0 || blue > 255)
		b_print_error(cub3d, "Blue color of F must be a value between 0-255.");
...
void	b_validate_floor_color(t_cub3d *cub3d, char *line)
{
	...
	if (line[0] == 'F')
	{
		...
		if (*cub3d->config->floor_color->string == '\0')
			b_print_error(cub3d, "F element cant' be empty.");
