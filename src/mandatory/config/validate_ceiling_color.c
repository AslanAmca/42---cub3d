...
static void validate_comma(t_cub3d *cub3d)
{
	...
	if (count != 2)
		print_error(cub3d, "C take a value in RGB format. The RGB value consists of 3 parts separated by 2 commas.");
}
...
static void validate_red_color(t_cub3d *cub3d)
{
	...
	if (red_len > 3)
		print_error(cub3d, "Red color of C must be between 1-3 characters. (1 - 10 - 100).");
	i = 0;
	while (i < red_len)
	{
		if (!ft_is_digit(red_string[i]))
			print_error(cub3d, "Red color of C must consist of digit only. (0 - 9)");
		i++;
	}
...
static void validate_green_color(t_cub3d *cub3d)
{
	...
	if (green_len > 3)
		print_error(cub3d, "Green color of C must be between 1-3 characters. (1 - 10 - 100).");
	i = 0;
	while (i < green_len)
	{
		if (!ft_is_digit(green_string[i]))
			print_error(cub3d, "Green color of C must consist of digit only. (0 - 9)");
		i++;
	}
...
static void validate_blue_color(t_cub3d *cub3d)
{
	...
	if (blue_len > 3)
		print_error(cub3d, "Blue color of C must be between 1-3 characters. (1 - 10 - 100).");
	i = 0;
	while (i < blue_len)
	{
		if (!ft_is_digit(blue_string[i]))
			print_error(cub3d, "Blue color of C must consist of digit only. (0 - 9)");
		i++;
	}
